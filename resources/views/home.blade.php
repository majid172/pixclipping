...
@section('content')
    ...
    <!-- Testimonials -->
    {{-- <section id="testimonials" class="section-1 carousel">
        <div class="overflow-holder">
            <div class="container">
                <div class="row text-center intro">
                    <div class="col-12 heading">
                        <h2 class="">Customer Testimonials</h2>
                        <p class="text-center testimonial subtitle" style="padding:40px 40px">Our customers are satisfied with the work we do. The greatest gratification is to receive recognition for what we have built. This motivates us to improve even more.</p>
                    </div>
                </div>
                <div class="swiper-container mid-slider items">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide slide-center text-center item">
                            <div class="row card">
                                <div class="col-12">
                                    <img src="{{asset('assets/images/team-1.jpg')}}" alt="Adams Baker" class="person">
                                    <h4>Adams Baker</h4>
